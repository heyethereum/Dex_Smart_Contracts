...
import {IOrchardFairLaunch} from "../interfaces/liquidityMining/IOrchardFairLaunch.sol";
import {IOrchardRewardLocker} from "../interfaces/liquidityMining/IOrchardRewardLocker.sol";

/// FairLaunch contract for Orchard DMM Liquidity Mining program
    ...
    ReentrancyGuard
{
    ...
    IOrchardRewardLocker public immutable rewardLocker;
    ...
    constructor(
        ...
        IOrchardRewardLocker _rewardLocker
