...
contract OrchardNetworkTokenV2 is OwnableUpgradeable, ERC20BurnableUpgradeable {
    using SafeERC20 for IERC20;

    address public oldORC;
    ...
    function initialize(address _oldORC, address _minter) external initializer {
        __ERC20_init("Orchard Swap v2", "ORC");
        __Ownable_init();
        require(_oldORC != address(0), "invalid old orc");
    ...
    function mintWitholdORC(uint256 amount) external {
        IERC20Burnable(oldORC).burnFrom(msg.sender, amount);
